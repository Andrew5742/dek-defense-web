...
export function StudentEditor({ student, onSave, onClose }: Props) {
  ...
  const [defenseFormat, setDefenseFormat] = useState(student.defenseFormat || 'offline')
    ...
    <div className="modal-backdrop">
      <div className="modal wide">
        ...
        <div className="form-grid">
          ...
          <label>Формат захисту<select value={defenseFormat} onChange={(e) => setDefenseFormat(e.target.value as 'offline' | 'online')}>
        ...
        <div className="modal-actions">
          ...
          <button className="primary" onClick={() => onSave({ fullName, groupName, thesisTitleEdited, supervisorEdited, consultant: consultant || undefined, notes, isAllowedToRegister, defenseFormat })}>Зберегти</button>
        </div>
      </div>
    </div>
  )
